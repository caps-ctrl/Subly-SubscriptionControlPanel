    ...
    <div className="relative bg-zinc-100  min-h-screen overflow-scroll font-sans text-zinc-950 dark:bg-black dark:text-zinc-50">
      ...
      <div>
        <div className="fixed top-0 left-0 ">
          <aside className="min-h-screen  hidden overflow-hidden sm:block  sm:max-w-50 border-r border-zinc-200 flex flex-col justify-between bg-zinc-200  shadow-sm backdrop-blur dark:border-zinc-800 dark:bg-zinc-950/70 lg:sticky lg:top-6 lg:h-[calc(100vh-3rem)] lg:self-start">
            <div>
              <Link href="/">
                {" "}
                <div className="flex items-center justify-center     p-5 ">
                  ...
                  <h1 className="text-2xl hidden sm:block mr-10 font-bold">
                    ubly
                  </h1>
                </div>{" "}
              </Link>
        ...
        <main className="ml-0 overflow-hidden pt-20 sm:ml-50 sm:pt-0">
          {children}
        </main>
      </div>
    </div>
